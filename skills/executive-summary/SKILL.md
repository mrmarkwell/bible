...
- **Automatic 10th Iteration Cadence**: Every 10th Ralph loop iteration (`run_number % 10 == 0`, e.g. Run #010, #020, #030...) is dedicated to curating and presenting this executive summary.
