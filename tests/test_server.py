...
class TestWebServerEndpoints(unittest.TestCase):
    ...
    def test_web_ui_rag_study_and_character_studio_integration(self) -> None:
        ...
        self.assertIn('id="select-rag-passages"', html_text)
        self.assertIn('id="select-rag-testament"', html_text)
        self.assertIn('id="select-rag-genre"', html_text)
        self.assertIn('id="select-rag-epoch"', html_text)
        self.assertIn('id="select-rag-locus"', html_text)
        self.assertIn('id="select-rag-fusion"', html_text)
        ...
        # 2. Verify style.css defines split-screen, studio, and RAG card styles
        status, _, body = self._get("/style.css")
        self.assertEqual(status, 200)
        css_text = body.decode("utf-8")
        ...
        self.assertIn(".rag-passage-pericope-title", css_text)
        self.assertIn(".rag-passage-prop", css_text)
        self.assertIn(".rag-pill-locus", css_text)
        self.assertIn(".rag-pill-reason", css_text)
        ...
        self.assertIn("selectRagTestament", js_text)
        self.assertIn("selectRagGenre", js_text)
        self.assertIn("selectRagEpoch", js_text)
        self.assertIn("selectRagLocus", js_text)
        self.assertIn("selectRagFusion", js_text)
